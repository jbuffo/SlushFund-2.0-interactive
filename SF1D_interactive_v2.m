...
t_f=30000000;           %% Final Time (sec) - length of run
time=[t_i:t_f:t_f];
for k=1:length(time)-1;

%% Input Parameters 
%% Change these as desired - these govern the majority of the results
Ttop=250;                %% Ice top temp (K)
Tbottom=272.44;          %% Ocean Temp (K) [MgSO4 12.3ppt-273.0K, 100ppt-271.31K, 282ppt-267.5K NaCl 34ppt-271.2K]
