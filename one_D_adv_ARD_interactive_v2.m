function [T_np1_k_j,phi_np1_k_j,S_np1_k_j,w_np1_k_j]=one_D_adv_ARD_interactive_v2(...
  ...
  delta_T=Tm-(-(9.1969758*(10^-5)*S_np1_km1_j.^2)-0.03942059*S_np1_km1_j+...
    ...
    for i=2:matrix_dimension;
        if w_np1_k_j(i)==0;
            ...
            c2(i)=-D_s_plus(i);
        elseif w_np1_k_j(i)>0;
            a2(i)=1+D_s_plus(i)+D_s_minus(i)+D_w_s(i);
            b2(i)=-D_s_minus(i);
            c2(i)=-D_s_plus(i)-D_w_s(i);
        else
            a2(i)=1+D_s_plus(i)+D_s_minus(i)-D_w_s(i);
            b2(i)=-D_s_minus(i)+D_w_s(i);
            c2(i)=-D_s_plus(i);
        end
    end
